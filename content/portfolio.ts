...
export const projects: Project[] = [
  {
    ...
    tags: ["residential", "event", "psychedelic", "immersive"],
    featured: true,
  },
  {
    ...
    category: "commercial",
    videoUrl: "/Reefer-Dreamers.mp4",
    images: ["/4.JPG", "/5.JPG", "/6.JPG"],
    tags: ["commercial", "event", "jungle", "nightclub"],
    featured: true,
  ...
  },
  {
    ...
    tags: ["commercial", "event", "halloween", "wonderland"],
    featured: true,
  ...
  },
  {
    ...
    tags: ["commercial", "event", "space", "symphony"],
    featured: true,
  ...
  },
  {
    ...
    category: "residential",
    images: ["/13.jpg", "/17.jpg", "/18.jpg"],
    tags: ["residential", "event", "gaming", "fantasy"],
    featured: true,
  ...
  },
  {
    ...
    category: "residential",
    images: ["/21.JPG", "/23.jpg"],
    tags: ["residential", "event", "halloween", "jungle"],
    featured: true,
    location: "Jester's Wondrous Funhouse",
